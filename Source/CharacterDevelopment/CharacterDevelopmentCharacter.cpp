...
void ACharacterDevelopmentCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent){
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ACharacterDevelopmentCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ACharacterDevelopmentCharacter::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACharacterDevelopmentCharacter::OnResetVR);
}


void ACharacterDevelopmentCharacter::OnResetVR()
{
	// If CharacterDevelopment is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in CharacterDevelopment.Build.cs is not automatically propagated
...
void ACharacterDevelopmentCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ACharacterDevelopmentCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
